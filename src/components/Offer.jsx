...
const Offer = () => {
  return (
    <section className="bg-white min-h-[70vh] p-[35px] md:p-28">
      ...
      <div className="grid grid-cols-1 md:grid-cols-10 gap-4 md:gap-6 mt-14">
        {/* 30% width section */}
        <div className="col-span-1 md:col-span-3 bg-white rounded-lg p-5 lg:p-8 shadow-lg shadow-red-200 border border-red-100">
        ...
        {/* 70% width section */}
        <div className="col-span-1 md:col-span-7 bg-white rounded-lg p-5 lg:p-8 shadow-lg shadow-red-200 border border-red-100">
          <div className="flex flex-col h-full">
            <div className="flex-grow border-b border-[#DF312E]">
              <h3 className="text-tradecenter_red text-[24px] font-[700] pb-7">
                Procurement for Individuals
