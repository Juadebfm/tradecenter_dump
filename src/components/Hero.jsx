...
const Hero = () => {
  return (
    <section className="min-h-[100vh] relative bg-[url('/hero.webp')] bg-center bg-no-repeat bg-cover">
      ...
      {/* Content */}
      <div className="absolute inset-0 flex flex-col justify-center items-center text-white text-center px-[35px] lg:px-16 2xl:px-28 w-[100vw] lg:w-[70%] mx-auto ">
        ...
        <p className="max-w-2xl text-lg md:text-xl w-[100vw] lg:w-[60%] mt-4 px-[35px] lg:px-0 !leading-[1.6]">
